 ...
 * FlowStateComponent
 *
 * Note: If your component will be removed permanently, call `this.source?.destroy()`
...
export class FlowStateComponent extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const sourceConfig = Object.hasOwn(this, 'source') ? this.source : {};
    this.#source = new FlowSource(this, sourceConfig);
    delete this.source;
