export class FlowState {
  ...
  constructor(root, config = {}, hooks = {}, options = {}) {
    // Check: 1
  ...
  #buildSnapshot() {
    ...
    return {
      ...
      id: this.#id,
      rootTag,
      label: this.#label,   // ← add this line
      parentId,
      values,
  ...
  static create(root, config = {}, hooks = {}, options = {}) {
    if (root instanceof Node) {
      return new FlowState(root, config, hooks, options);
    }
