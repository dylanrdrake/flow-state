export class NodeState {
  ...
  constructor(root, config = {}) {
    ...
    Object.defineProperty(instanceApi, 'update', {
      value: this.#publicUpdateReady.bind(this),
      writable: false,
      enumerable: true,
      configurable: false
    });
    ...
    Object.defineProperty(instanceApi, 'watch', {
    ...
    Object.defineProperty(instanceApi, 'get', {
    ...
    Object.defineProperty(instanceApi, 'hasKey', {
    ...
    Object.defineProperty(this.#root, '__state__', {
      value: {
  ...
  static create(root, config = {}) {
    ...
    throw Error("NodeState.create requires the root to be a DOM Node or a string ID selector!");
  }
}
